  ...
  const projectsData = [
    {
      ...
      category: "Web",
      description: "A high-performance financial dashboard handling real-time data visualization and secure user authentication.",
    ...
    },
    {
      ...
      category: "Mobile",
      description: "A cross-platform mobile application that tracks workouts, integrates with device health kits, and provides analytics.",
    ...
    },
    {
      ...
      description: "A comprehensive Figma design system and component library built for a modern boutique clothing brand.",
    ...
    },
    {
      ...
      category: "Web",
      description: "A SaaS platform utilizing OpenAI's API to generate marketing copy, blog posts, and social media content.",
  ...
  return (
    <main className="flex-1 w-full px-6 md:px-16 py-12 max-w-7xl mx-auto">
      ...
      <section className="mb-12">
        <h1 className="font-mono text-cyan-600 dark:text-[#00F5FF] text-2xl md:text-3xl mb-6">/featured_projects</h1>
        <p className="text-lg text-slate-700 dark:text-white/80 leading-relaxed font-light max-w-3xl">
          A selection of my recent work across different platforms and disciplines. 
          ...
          >
            ...
            <div className="p-8 flex flex-col flex-1">
              <div className="flex justify-between items-start mb-4">
                ...
                <a href="#" className="text-slate-400 hover:text-cyan-600 dark:text-white/30 dark:hover:text-[#00F5FF] transition-colors">
