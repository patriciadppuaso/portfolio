...
export default function Skills() {
  ...
  const activeSkillTab = useStore((state) => state.activeSkillTab);
  const setActiveSkillTab = useStore((state) => state.setActiveSkillTab);

  <Draggable nodeRef={skillsRef} handle=".drag-handle" bounds="parent">
    <div
      ref={skillsRef}
          ...
          <div className="space-y-4 h-[180px]">
            <div>
              ...
              <p className="text-xs ml-6 mt-1 leading-relaxed">
                Web & Mobile Technologies, React, Tailwind CSS, HTML/CSS/JS, API
                Integration
              </p>
            </div>
            <div>
        ...
        {activeSkillTab === "soft" && (
          <div className="space-y-4 h-[180px]">
            <div>
              ...
              <p className="text-xs ml-6 mt-1 leading-relaxed">
                Team Leadership, Project Management, Process Optimization, Task
                Delegation, Event Organization
              </p>
            </div>
            <div>
              <p className="font-bold flex items-center gap-2">
              ...
              <p className="text-xs ml-6 mt-1 leading-relaxed">
                Empathy & User Advocacy, Active Listening, Conflict Resolution,
